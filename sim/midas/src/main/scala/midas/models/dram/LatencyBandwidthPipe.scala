...
case class LatencyPipeConfig(params: BaseParams) extends BaseConfig {
  ...
  def elaborateWithNeoProfiler()(implicit p: Parameters): LatencyPipeWithNeoProfiler = Module(new LatencyPipeWithNeoProfiler(this))
}
...
class LatencyPipeWithNeoProfilerIO(val cfg: LatencyPipeConfig)(implicit p: Parameters) extends SplitTransactionModelWithNeoProfilerIO()(p) {
  val mmReg = new LatencyPipeMMRegIO(cfg)
}
...
class LatencyPipeWithNeoProfiler(cfg: LatencyPipeConfig)(implicit p: Parameters) extends SplitTransactionModelWithNeoProfiler(cfg)(p)  {
  lazy val io = IO(new LatencyPipeWithNeoProfilerIO(cfg))
